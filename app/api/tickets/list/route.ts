...
export async function GET(request: Request) {
  try {
    ...
    // This is copied directly from /api/dashboard/stats/route.ts
    type TicketDoc = { id?: string; title?: string; createdAt?: unknown; updatedAt?: unknown; buildingName?: unknown; assignedTechnicianPhone?: unknown; [key: string]: unknown };
    const mappedTickets = (tickets as TicketDoc[]).map((ticket) => ({
      ...ticket,
