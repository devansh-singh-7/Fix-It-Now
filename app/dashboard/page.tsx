...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const deniedParam = searchParams.get('accessDenied');
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <NavBar />
      {accessDeniedToast && (
        <div className="fixed right-4 top-20 z-50 max-w-sm rounded-lg border border-red-200 bg-red-50 px-4 py-3 shadow-lg dark:border-red-900/50 dark:bg-red-950/90">
          <p className="text-sm font-medium text-red-700 dark:text-red-300">{accessDeniedToast}</p>
        </div>
      )}
