...
export default function BuildingManagementPage() {
  ...
  const handleAssignTechnician = async () => {
    ...
    if (assignMode === 'new' && !techEmail) {
      setError('Please enter the technician email address');
      return;
    }
    ...
    try {
      ...
      setSuccess(result.message || `Technician has been assigned to ${selectedBuildingName}`);
      setTechEmail('');
      setSelectedExistingTech(null);
          ...
          <div className="mb-10">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl">
                Create and manage buildings, generate unique join codes for residents and
                technicians
              </p>
            </motion.div>
          </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <span className="text-xs font-normal text-gray-500 dark:text-gray-400">
                        (Optional - assign any registered user)
                      </span>
                    </label>
                    <input
                      id="ownerEmail"
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Leave blank to assign yourself as the owner, or enter the email of any registered user. They will be granted owner permissions automatically.
                    </p>
                  </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-6 space-y-6">
                  ...
                  {loadingAvailable ? (
                    ...
                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                      ...
                      <p className="text-sm mt-1">
                        Add a new technician using the &quot;Add New&quot; tab
                      </p>
                    </div>
                  ) : (
              ...
              {/* Assign Registered User as Technician */}
              {assignMode === 'new' && (
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                    Assign Registered User as Technician
                  ...
                  <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-sm text-blue-800 dark:text-blue-300">
                      💡 Only registered users can be assigned as technicians. The user must have signed up on the platform first.
                    </p>
                  </div>
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Enter the email address of a registered user. They will be automatically assigned as a technician for this building.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 dark:border-gray-800">
              ...
              <button
                ...
                disabled={
                  addingTech ||
                  (assignMode === 'existing' ? !selectedExistingTech : !techEmail)
                }
