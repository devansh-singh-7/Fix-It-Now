...
export default function BuildingDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleAddTechnician = async () => {
        if (!userId || !newTechName || !newTechEmail) return;

        setAddingTech(true);
        setError("");

        try {
            const response = await fetch(`/api/buildings/${id}/technicians`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'x-user-id': userId,
                ...
                body: JSON.stringify({
                    name: newTechName,
                    email: newTechEmail,
                    phoneNumber: newTechPhone || undefined,
                }),
            });
            ...
            if (!result.success) {
                throw new Error(result.error || 'Failed to add technician');
            }
                ...
                <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                        ...
                        >
                            ...
                            {/* Add Technician Form */}
                            {showAddTech && (
                                <div className="mb-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 space-y-4">
                                    <div>
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            disabled={addingTech || !newTechName || !newTechEmail}
